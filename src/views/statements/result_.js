...
const isChecked=(id)=>{
const boolval=checked.filter(name => name === id)[0] ? true : false;
return boolval;
}

console.log()
console.log('=>',isChecked('checkbox2'));
const data={
    columns:[
        {
            label:<MDBInput label='' type='checkbox' 
            style={{width:'30px', margin:'0px 0px 15px 0px'}}
            id='checkbox1' 
            onClick={toggleCheck} />,
            field:'check',
            sort:'disabled',
    ...
    rows: [
      {
        ...
        checked={(checkbox1)=>{isChecked('checkbox1')}}
        onClick={toggleCheck} />,
        name: 'Tiger Nixon',
      ...
      },
      {
        ...
        checked={(checkbox2)=>{isChecked('checkbox2')}}
         onClick={toggleCheck}       
         />,
      ...
      {
        check:<MDBInput label=' ' type='checkbox' id='checkbox3' 
        checked={(checkbox3)=>{isChecked('checkbox3')}}
        onClick={toggleCheck} 
      ...
      {
        check:<MDBInput label=' ' type='checkbox' id='checkbox4'       
        checked={(checkbox4)=>{isChecked('checkbox4')}}
        onClick={toggleCheck} />,
        name: 'Cedric Kelly',
...
// import {MDBDataTableV5} from 'mdbreact';
// export default function WithCSV() {
